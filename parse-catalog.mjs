...
const INDIA_EXTRA = [
  ...
  ["MSG91","https://docs.msg91.com","SMS, WhatsApp, email, OTP and voice APIs for India","key","freemium"],
  ["Exotel","https://developer.exotel.com","Cloud telephony — calls, SMS, IVR, call masking","key","paid"],
  ["Gupshup","https://docs.gupshup.io","Conversational messaging — WhatsApp, SMS, RCS, chatbots","key","freemium"],
  ["Plivo","https://www.plivo.com/docs/","Voice + SMS APIs (India-founded, global)","key","freemium"],
  ["Fast2SMS","https://docs.fast2sms.com","Bulk SMS + OTP API popular with Indian devs, free credits","key","freemium"],
  ["2Factor","https://2factor.in","OTP verification + transactional SMS API","key","freemium"],
  ["Ozonetel","https://developer.ozonetel.com","CloudAgent telephony + contact center APIs","key","paid"],
  ["Kaleyra","https://developers.kaleyra.io","SMS, voice, WhatsApp CPaaS","key","paid"],
  ["Decentro","https://docs.decentro.tech","Banking + UPI + KYC APIs, plug-and-play fintech infra","key","freemium"],
  ["Signzy","https://signzy.com","Digital onboarding + KYC/AML verification APIs","key","paid"],
  ["Karza (Perfios)","https://karza.in","Identity, financial and business verification APIs","key","paid"],
  ["HyperVerge","https://hyperverge.co","AI-based face match, liveness and document KYC APIs","key","paid"],
  ["Bureau","https://bureau.id","Identity decisioning + fraud prevention APIs","key","paid"],
  ["AuthBridge","https://authbridge.com","Background verification + KYC APIs","key","paid"],
  ["Zoop.one","https://zoop.one","Aadhaar, PAN, GST, bank and vehicle verification APIs","key","freemium"],
  ["Gridlines","https://gridlines.io","KYC, KYB and financial verification APIs","key","freemium"],
  ["Attestr","https://attestr.com","Identity + business verification APIs, pay-per-use","key","freemium"],
  ["ClearTax API","https://cleartax.in/s/gst-api","GST filing, e-invoicing and e-way bill APIs","key","paid"],
  ["Masters India","https://mastersindia.co/gst-api/","GST, e-invoice, e-way bill and PAN verification APIs","key","paid"],
  ["Cygnet GSP","https://cygnetgsp.in","Government-authorized GST Suvidha Provider APIs","key","paid"],
  ["5paisa API","https://www.5paisa.com/developerapi","Free trading API — equities, F&O, market data","key","free"],
  ["ICICI Breeze","https://api.icicidirect.com","ICICIdirect trading + historical market data API","key","free"],
  ["Groww API","https://groww.in/trade-api","Trading + market data API for Groww accounts","key","freemium"],
  ["Kotak Neo API","https://www.kotaksecurities.com/trading-api/","Kotak Securities trading API — orders, feeds","key","free"],
  ["Yellow.ai","https://docs.yellow.ai","Conversational AI + chatbot automation APIs","key","paid"],
  ["Haptik","https://www.haptik.ai","Conversational CX + WhatsApp chatbot APIs","key","paid"],
  ["Uniphore","https://developer.uniphore.com","Conversational AI + voice analytics APIs","key","paid"],
  ["Gnani.ai","https://www.gnani.ai","Voice-first conversational AI + speech APIs, Indic","key","paid"],
  ["BillDesk","https://www.billdesk.com","Payment gateway + bill payments (enterprise)","key","paid"],
  ["CCAvenue","https://www.ccavenue.com/developers.jsp","Payment gateway — cards, UPI, netbanking, 200+ options","key","freemium"],
  ["Easebuzz","https://docs.easebuzz.in","Payments, payouts and neobanking APIs for SMBs","key","freemium"],
  ["Open Money","https://developers.bankopen.co","Connected banking + payments + payouts APIs","key","freemium"],
  ["Perfios","https://www.perfios.com","Bank statement analysis + financial data APIs","key","paid"]
];
